...
## ORDER 001 · 2026-07-09T13:31Z · status: new
priority: P1
...
priority: P1
do: No activity has reached this repo since seeding (~13:31Z). If you are running: push your work-in-progress branch and overwrite control/status.md so the fleet can see you. If this is your first wake: execute ORDER 001 now. Standing convention: READY PRs with auto-merge, never drafts; status overwrite as the last step of every session.
why: a silent session is indistinguishable from a dead one; the heartbeat is how you exist to the fleet.
done-when: any commit or Project-written status.md lands.
